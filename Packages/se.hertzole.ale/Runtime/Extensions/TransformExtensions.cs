...
namespace Hertzole.ALE
{
	public static partial class LevelEditorExtensions
	{
		...
		public static void SetScaleFrom(this Transform target, Vector3 worldPivot, Vector3 newScale)
		{
			...
			Vector3 scaleRatio = new Vector3(MathfExtensions.SafeDivide(newScale.x, localScale.x), MathfExtensions.SafeDivide(newScale.y, localScale.y), MathfExtensions.SafeDivide(newScale.z, localScale.z));
		...
		public static Vector3 GetCenter(this Transform transform, ManipulationHandle.CenterTypes centerType)
		{
			if (centerType == ManipulationHandle.CenterTypes.Solo)
			{
			...
			if (centerType == ManipulationHandle.CenterTypes.All)
			{
