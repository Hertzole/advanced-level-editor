...
public class TypesTest : MonoBehaviour
{
    ...
    public Transform ReferenceTest
    {
        get
        {
    ...
    public AdvancedClass AdvancedClass
    {
        get
        {
    ...
    public AdvancedStruct AdvancedStruct
    {
        get
        {
    ...
    public SimpleStruct[] StructArray
    {
        get
        {
            return structArray;
    ...
    public List<AdvancedClass> AdvancedList
    {
        get
        {
            return advancedList;
