...
public class ExposedTemplate : MonoBehaviour, IExposedToLevelEditor
{
	...
	private readonly ExposedField[] ALE__GENERATED__cachedProperties =
	{
	...
	protected virtual bool ALE__GENERATED__ModifyValue(object value, ref bool changed)
	{
		...
		if (ALE__GENERATED__editingId == 1)
		{
		...
		if (ALE__GENERATED__editingId == 2)
		{
		...
		if (ALE__GENERATED__editingId == 3)
		{
		...
		if (ALE__GENERATED__editingId == 11)
		{
		...
		if (ALE__GENERATED__editingId == 12)
		{
		...
		if (ALE__GENERATED__editingId == 13)
		{
